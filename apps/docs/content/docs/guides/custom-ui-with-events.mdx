...
Origin ships generic tools (`show_presentation`, `set_state`, `send_custom_event`)
...
See [UI tools and companion plugins](/docs/guides/ui-tools-and-companion) for how
to register, omit, or build your own UI tools.
...
- [UI tools and companion plugins](/docs/guides/ui-tools-and-companion)
